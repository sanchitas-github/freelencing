...
// 			<h1 className='text-lg mb-4 font-bold p-4'><strong>Hire a Freelancer </strong></h1>
//       {address ? (
//         <React.Fragment>
...
//         <React.Fragment>
//           <button
//             className="bg-blue-500 m-4 p-4 hover:bg-blue-700 text-grey font-bold py-2 px-4 rounded"
//             onClick={handleConnectClick}
//             disabled={isLoading}
//           >
//             {isLoading ? 'Connecting...' : 'Connect to Wallet and Pay Fee'}
//           </button>
